...
class AttackManager:
    ...
    def initPhishing(self, user) -> None:
    ...
    def main_menu(self, user):
        while True:
            ...
            if choice == '1':
                ...
                self.initPhishing(user)
            elif choice == '4':
                self.view_attack_reports(user.username)
            elif choice == '5':
                print("Saliendo...")
                break
            else:
    ...
    def view_attack_reports(self, username):
        reports_dir = 'ataques'
...
if __name__ == '__main__':
    ...
    user = attack_manager.authenticate_user()
    attack_manager.main_menu(user)
